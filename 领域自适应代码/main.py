...
parser.add_argument('--data', type=str, default=r'dataset/Office31/Original_images/')
parser.add_argument('--early_stop', type=int, default=20)
parser.add_argument('--lamb', type=float, default=0.5)
parser.add_argument('--trans_loss', type=str, default='JDA')
...
def load_data(src, tar, root_dir):
    ...
    source_loader = data_loader.load_data(
        folder_src, args.batchsize, True, {'num_workers': 0})
    target_train_loader = data_loader.load_data(
        folder_tar, args.batchsize, True, {'num_workers': 0})
    target_test_loader = data_loader.load_data(
        folder_tar, args.batchsize, False, {'num_workers': 0})
