...
def sensor_param_init(args):
    dataset = args.dataset
    if dataset == 'DSADS':
        domains = ['S1', 'S2', 'S3', 'S4']
        args.input_shape = (45, 1, 125)
        args.num_classes = 19
    elif dataset == 'EMG':
        domains = ['S1', 'S2', 'S3', 'S4']
        args.input_shape = (8, 1, 256)
        args.num_classes = 6
    elif dataset == 'DB2':
        domains = ['S1', 'S2', 'S3', 'S4']
        args.input_shape = (12, 1, 520)
        args.num_classes = 6
    elif dataset == 'oymotion':
        domains = ['S1', 'S2', 'S3', 'S4']
        args.input_shape = (8, 1, 256)
        args.num_classes = 6
    elif dataset == 'uschad':
        domains = ['S1', 'S2', 'S3', 'S4']
        args.input_shape = (6, 1, 500)
        args.num_classes = 12
    elif dataset == 'pamap':
        domains = ['S1', 'S2', 'S3', 'S4']
        args.input_shape = (27, 1, 512)
        args.num_classes = 25
    else:
        print('No such dataset exists!')
    args.domains = domains
